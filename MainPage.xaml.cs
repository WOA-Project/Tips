...
namespace Tips
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            NavView_Navigate("Battery", new EntranceNavigationTransitionInfo());
        ...
        private void NavView_Navigate(string navItemTag, NavigationTransitionInfo transitionInfo, object parameter)
        {
            Type _page = null;
        ...
        private void On_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            if (ContentFrame.SourcePageType != null)
            {
                ...
                NavView.Header = (NavView.SelectedItem as MUXC.NavigationViewItem).Content;
            }
        }
    }
}
